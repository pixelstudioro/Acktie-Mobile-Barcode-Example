// Example for the Acktie Mobile Barcode Code reader (for both iOS and Android)
...
/**
 * Read Barcode code from Camera feed continuously until user press the done button.
 */
...
/**
 * Scan Barcode code from Camera feed only after user presses Scan button.
 * Once the module successfully detects the Barcode code the camera will
 * stop.
 */
 ...
 * exit the Barcode scanning mode.
 */
